...
RE2C = re2c
AWK = nawk
shared_objects_gtk4 = gtk4.lo helper.lo src/G/GObject.lo src/G/GApplication.lo src/Atk/AtkPlug.lo src/Gtk/Gtk.lo src/Gtk/GtkWidget.lo src/Gtk/GtkApplication.lo src/Gtk/GtkWindow.lo
